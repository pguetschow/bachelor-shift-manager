...
urlpatterns = [
    ...
    path('api/companies/<int:company_id>/day/<str:date>/', views.api_company_day_schedule,
         name='api_company_day_schedule'),
    path('api/companies/<int:company_id>/employees/<int:employee_id>/schedule/', views.api_company_employee_schedule,
         name='api_company_employee_schedule'),
    path('api/companies/<int:company_id>/employees/<int:employee_id>/yearly/',
         views.api_company_employee_yearly_schedule, name='api_company_employee_yearly_schedule'),
    path('api/companies/<int:company_id>/employee-statistics/', views.api_company_employee_statistics,
         name='api_company_employee_statistics'),
