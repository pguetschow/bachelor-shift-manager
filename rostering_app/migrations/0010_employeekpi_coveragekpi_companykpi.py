    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_kpis',
                                              to='rostering_app.company')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='kpis',
                                               to='rostering_app.employee')),
            ],
            options={
                'indexes': [models.Index(fields=['company', 'year', 'month'], name='rostering_a_company_cf4621_idx'),
                            models.Index(fields=['employee', 'year', 'month'], name='rostering_a_employe_19b9a2_idx'),
                            models.Index(fields=['algorithm'], name='rostering_a_algorit_0c076c_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coverage_kpis',
                                              to='rostering_app.company')),
            ],
            options={
                'indexes': [
                    models.Index(fields=['company', 'start_date', 'end_date'], name='rostering_a_company_985e18_idx'),
                    models.Index(fields=['algorithm'], name='rostering_a_algorit_ed17a4_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculated_at', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_kpis',
                                              to='rostering_app.company')),
            ],
            options={
                'indexes': [models.Index(fields=['company', 'year', 'month'], name='rostering_a_company_9f5b09_idx'),
                            models.Index(fields=['algorithm'], name='rostering_a_algorit_99d37b_idx')],
